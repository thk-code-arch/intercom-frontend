<template>
  <div class="flex justify-center px-4 mx-auto">
    <div class="max-w-6xl p-8 m-8 bg-white rounded-lg">
        ...
        <div class="flex items-center flex-none px-6 py-2 mb-4 border-b">
            <div class="flex flex-col">
              <h1 class="mb-2 text-2xl font-medium"><strong>{{currentUser.username}}</strong> Profile</h1>
      ...
      <h2 class="mb-4 text-sm font-medium tracking-wide text-indigo-400 uppercase">Data</h2>
      <h3>
    ...
    <div class="max-w-lg p-8 m-8 bg-white rounded-lg">
      ...
      <img :src="currentUser.profile_image" class="w-64 h-64 m-auto text-black rounded-full">
