<template>
  ...
  <div class="flex items-start" id="menu">
        <router-link to="/" class="px-0 py-3 border-b-2 border-transparent lg:p-4 hover:border-indigo-400"><svg class="inline-block w-5 h-5 text-black align-middle fill-current" viewBox="0 0 20 20" fill="currentColor" className="home w-6 h-6" style="--darkreader-inline-fill:currentColor;" data-darkreader-inline-fill=""><path d="M10.707 2.293a1 1 0 00-1.414 0l-7 7a1 1 0 001.414 1.414L4 10.414V17a1 1 0 001 1h2a1 1 0 001-1v-2a1 1 0 011-1h2a1 1 0 011 1v2a1 1 0 001 1h2a1 1 0 001-1v-6.586l.293.293a1 1 0 001.414-1.414l-7-7z" /></svg></router-link>
